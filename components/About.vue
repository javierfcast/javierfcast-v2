  ...
  <section class="about" id="about">
    <div class="jf-container">
      <div class="content">
        ...
        <h3>I love coffee, craft beers, traveling, <a href="https://instagram.com/javiercastillo.art" target="_blank" rel="noopener noreferrer">painting</a>, playing the piano and <a href="#mixtapes">listening to all types of music</a>.</h3>
      </div>
